// ================================================================
// PAGES/SETTINGS.JS — Tab Cài đặt
// Tùy chọn cấu hình, bật/tắt dữ liệu mô phỏng, xuất/nhập dữ liệu,
// đặt lại toàn bộ tiến độ. Chỉ chứa logic của tab này (template HTML +
// render) — mọi thao tác đọc/ghi thật sự ủy quyền cho storage.js.
// ================================================================
