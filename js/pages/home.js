// ================================================================
// PAGES/HOME.JS — Tab Trang chủ
// Dashboard hành động nhanh: hôm nay cần học gì, tổng tiến độ, tổng
// quan chủ đề để bấm học ngay. Chỉ chứa logic của tab này (template
// HTML + render) — không chứa thuật toán (fsrs.js) hay lưu trữ dữ
// liệu (storage.js), chỉ gọi vào các lớp đó qua `db`/hàm fsrs.
// ================================================================
